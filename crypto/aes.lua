...
local function xor_intx4(a1, a2, a3, a4, b1, b2, b3, b4)
	return bxor(a1, b1), bxor(a2, b2), bxor(a3, b3), bxor(a4, b4)
end
...
local function encryptBlock(xk, s0, s1, s2, s3)
	s0 = bxor(s0, xk[1])
	s1 = bxor(s1, xk[2])
	s2 = bxor(s2, xk[3])
	s3 = bxor(s3, xk[4])
...
local function decryptBlock(xk, s0, s1, s2, s3)
	s0 = bxor(s0, xk[1])
	s1 = bxor(s1, xk[2])
	s2 = bxor(s2, xk[3])
	s3 = bxor(s3, xk[4])
...
local function expandKey(key)
	...
	local nk = #key / 4
	for i = 1, nk do
		enc[i] = bytes2uint32(key:byte((i - 1) * 4 + 1, i * 4))
	end
	for i = nk, kl - 1 do
		local t = enc[i]
		if i % nk == 0 then
...
local function str2int32s(s)
	if #s == 16 then
		return
			bytes2uint32(s:byte(1, 4)),
			bytes2uint32(s:byte(5, 8)),
			bytes2uint32(s:byte(9, 12)),
			bytes2uint32(s:byte(13, 16))
	end
	assert(#s % 4 == 0)
	local res = {}
	for i = 1, #s / 4 do
		res[i] = bytes2uint32(s:byte((i - 1) * 4 + 1, i * 4))
	end
	return table.unpack(res)
end

local function int32x4ToStr(b1, b2, b3, b4)
	return string.char(
		uint8(brshift(b1, 24)),
		uint8(brshift(b1, 16)),
		uint8(brshift(b1, 8)),
...
local function int32s2str(b1, b2, b3, b4, b5, ...)
	if b4 and b5 == nil then
		return int32x4ToStr(b1, b2, b3, b4)
	end
	local b = {b1, b2, b3, b4, b5, ...}
	local res = ''
	for _, n in ipairs(b) do
		res = res .. string.char(uint32ToBytes(n))
	end
	return res
end

local function generateKey(rand)
	local k = {}
	rand = rand or math.random
	for i = 1, 16 do
		k[i] = math.floor(rand() * 0xff)
	end
	return string.char(table.unpack(k))
end

local function generateVec(rand)
	local vec = {}
	rand = rand or math.random
	for i = 1, 4 do
		vec[i] = math.floor(rand() * 0xffffffff)
	end
	return vec
end
...
local function loadKey(file)
	...
	if kl ~= 16 and kl ~= 24 and kl ~= 32 then
		return nil, 'Not a valid AES key length '..kl
	end
	return key
end

local Cipher = {}
Cipher.mt = { __index = Cipher }
...
function Cipher:encryptInt32s(s1, s2, s3, s4)
	return encryptBlock(self._enc, s1, s2, s3, s4)
end

function Cipher:decryptInt32s(s1, s2, s3, s4)
	return decryptBlock(self._dec, s1, s2, s3, s4)
end

function Cipher:encrypt(data)
	expect(1, data, 'string')
	assert(#data == 16, 'data block must be exactly 16 bytes')
	return int32x4ToStr(encryptBlock(self._enc, str2int32s(data)))
end

function Cipher:decrypt(data)
	expect(1, data, 'string')
	assert(#data == 16, 'data block must be exactly 16 bytes')
	return int32x4ToStr(decryptBlock(self._dec, str2int32s(data)))
end
...
function CipherStream:new(o, cipher)
	assert(o, 'Cannot new from an abstract object')
...
function CipherStream:encryptInt32s(...)
	error('Not implemented')
end

function CipherStream:decryptInt32s(...)
	error('Not implemented')
end

function CipherStream:encrypt(data)
	expect(1, data, 'string')
	assert(#data % 16 == 0, 'data block must in chunks of 16 bytes')
	return int32s2str(table.unpack(self:encryptInt32s(str2int32s(data))))
end

function CipherStream:decrypt(data)
	expect(1, data, 'string')
	assert(#data % 16 == 0, 'data block must in chunks of 16 bytes')
	return int32s2str(table.unpack(self:decryptInt32s(str2int32s(data))))
end
...
function ECBStream:new(o, cipher)
	return setmetatable(CipherStream:new(o or {}, cipher), self.mt)
end

function ECBStream:encryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')

	local res = {}
	for i = 1, #data, 4 do
		res[i], res[i + 1], res[i + 2], res[i + 3] = self.cipher:encryptInt32s(table.unpack(data, i, i + 3))
	end
	return res
end

function ECBStream:decryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')

	local res = {}
	for i = 1, #data, 4 do
		res[i], res[i + 1], res[i + 2], res[i + 3] = self.cipher:decryptInt32s(table.unpack(data, i, i + 3))
	end
	return res
end
...
function CBCStream:encryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')

	local res = {}
	local v = self.enc_vec
	local v1, v2, v3, v4 = v[1], v[2], v[3], v[4]
	for i = 1, #data, 4 do
		v1, v2, v3, v4 = self.cipher:encryptInt32s(xor_intx4(v1, v2, v3, v4, table.unpack(data, i, i + 3)))
		res[i], res[i + 1], res[i + 2], res[i + 3] = v1, v2, v3, v4
	end
	self.enc_vec = {v1, v2, v3, v4}
	return res
end

function CBCStream:decryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')

	local res = {}
	local v = self.dec_vec
	local v1, v2, v3, v4 = v[1], v[2], v[3], v[4]
	for i = 1, #data, 4 do
		local s1, s2, s3, s4 = table.unpack(data, i, i + 3)
		res[i], res[i + 1], res[i + 2], res[i + 3] = xor_intx4(v1, v2, v3, v4, self.cipher:decryptInt32s(s1, s2, s3, s4))
		v1, v2, v3, v4 = s1, s2, s3, s4
	end
	self.dec_vec = {v1, v2, v3, v4}
	return res
end

-- Counter mode

local CTRStream = setmetatable({}, CipherStream.mt)
CTRStream.mt = { __index = CTRStream }

function CTRStream:new(o, cipher, vec)
	o = setmetatable(CipherStream:new(o or {}, cipher), self.mt)
	o.enc_vec = vec or 0
	o.dec_vec = o.enc_vec
	return o
...
function CTRStream:encryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')
	...
	local v = self.enc_vec
	for i = 1, #data, 4 do
		local v1, v2, v3, v4 = self.cipher:encryptInt32s(uint32ToBytes(v))
		v = band(v + 1, 0xffffffff)
		res[i], res[i + 1], res[i + 2], res[i + 3] = xor_intx4(v1, v2, v3, v4, table.unpack(data, i, i + 3))
	end
	self.enc_vec = v
	return res
end

function CTRStream:decryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')
...
function CFBStream:encryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')
	...
	local v1, v2, v3, v4 = v[1], v[2], v[3], v[4]
	for i = 1, #data, 4 do
		v1, v2, v3, v4 = xor_intx4(data[i], data[i + 1], data[i + 2], data[i + 3], self.cipher:encryptInt32s(v1, v2, v3, v4))
		res[i], res[i + 1], res[i + 2], res[i + 3] = v1, v2, v3, v4
	end
	self.enc_vec = {v1, v2, v3, v4}
	return res
...
function CFBStream:decryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')
...
function OFBStream:encryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')
	...
	local v1, v2, v3, v4 = v[1], v[2], v[3], v[4]
	for i = 1, #data, 4 do
		v1, v2, v3, v4 = self.cipher:encryptInt32s(v1, v2, v3, v4)
		res[i], res[i + 1], res[i + 2], res[i + 3] = xor_intx4(v1, v2, v3, v4, table.unpack(data, i, i + 3))
	end
	self.enc_vec = {v1, v2, v3, v4}
	return res
...
function OFBStream:decryptInt32s(data, ...)
	local data = type(data) == 'table' and data or {data, ...}
	assert(#data % 4 == 0, 'data block must in chunks of 4')
